...
class LinkedinAPI():
    ...
    def __init__(self, client_id, client_secret):
        ...
        self.rest_api = {'api_oauth2_authorization':('https://www.linkedin.com/oauth/v2/authorization', 'GET'),
            'api_oauth2_access_token':('https://www.linkedin.com/oauth/v2/accessToken', 'POST'),
    ...
    def do_request(self, request_url='', grant_type='', code='', redirect_uri='',
        ...
        headers_payload = {'User-Agent':'HTTP/1.1'}
        ...
        if access_token:
            headers_payload['Authorization'] = 'Bearer ' + self.percent_quote(access_token.get("access_token",""))
        ...
        # return result
        try:
            req = Request(request_url, data=query_string, headers=headers_payload)
            res = urlopen(req)
